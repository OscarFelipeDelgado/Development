...
//Librerias (preprocesor comands), código prefabricado

int main()
{
    /*First hello world in C language
    Nos sirve para varias líneas este comentario
    */

    printf("Hello Oscar");
    return 0; //Termina la función principal "main", termina ejecución exitosa del programa
    //Se pone siempre al final dentro main
}
// Basic Types:
//        Aritmeticos:
            (A) Valores enteros:
