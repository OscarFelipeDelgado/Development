...
function agregarElemento(){
    ...
    //Limpiraremos el campo de entrada, después de haberse ingresado el dato
...
function eliminarElemento(){
    ...
    lista.removeChild(lista.lastChild);//el lastChild nos ayuda a eliminar el último dato que se insertó
}